...
<div class="min-h-screen bg-[hsl(38_44%_96%)]">
    ...
    <aside class="fixed left-0 top-0 h-full w-64 bg-[hsl(20_30%_14%)] text-white z-50 overflow-y-auto">
        ...
        <nav class="p-4 space-y-1">
            ...
            <a href="valider_restaurant.php" class="flex items-center justify-between px-4 py-3 rounded-xl text-white/80 hover:bg-white/10 transition-colors">
        ...
        <header class="bg-white border-b border-[hsl(30_25%_86%)] px-8 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <?php if ($nb_restos_attente > 0): ?>
                    <a href="valider_restaurant.php" class="flex items-center gap-2 bg-orange-100 text-orange-700 px-4 py-2 rounded-xl text-sm font-medium animate-pulse hover:bg-orange-200 transition-colors">
