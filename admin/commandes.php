...
<div class="min-h-screen bg-[hsl(38_44%_96%)]">
    ...
    <aside id="admin-sidebar" class="fixed left-0 top-0 h-full w-64 bg-[hsl(20_30%_14%)] text-white z-50 overflow-y-auto -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
        ...
        <nav class="p-4 space-y-1">
            ...
            <a href="commandes.php" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-[hsl(14_72%_46%)] text-white transition-colors">
        ...
        <header class="bg-white border-b border-[hsl(30_25%_86%)] px-8 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                    <h1 class="font-display text-2xl font-bold text-[hsl(20_30%_14%)]">Gestion des Commandes</h1>
        ...
        <div class="p-8 space-y-6">
            ...
            <div class="grid grid-cols-4 gap-4">
                <div class="bg-white rounded-xl border border-[hsl(30_25%_86%)] p-4 shadow-soft text-center">
                    ...
                    <div class="text-sm text-[hsl(25_15%_42%)]">Total</div>
                </div>
                <div class="bg-white rounded-xl border border-[hsl(30_25%_86%)] p-4 shadow-soft text-center">
                ...
                <div class="bg-white rounded-xl border border-[hsl(30_25%_86%)] p-4 shadow-soft text-center">
                    <div class="text-2xl font-bold text-green-600"><?php echo $stats['livree']; ?></div>
                    <div class="text-sm text-[hsl(25_15%_42%)]">Livrées</div>
                </div>
                <div class="bg-white rounded-xl border border-[hsl(30_25%_86%)] p-4 shadow-soft text-center">
                    <div class="text-2xl font-bold text-red-500"><?php echo $stats['annulee']; ?></div>
                    <div class="text-sm text-[hsl(25_15%_42%)]">Annulées</div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-[hsl(30_25%_86%)] shadow-soft overflow-hidden">
                <div class="px-6 py-4 border-b border-[hsl(30_25%_86%)]">
                    <h3 class="font-semibold text-[hsl(20_30%_14%)]">Dernières commandes</h3>
                </div>
                        ...
                        <tbody class="divide-y divide-[hsl(30_25%_86%)]">
                            ...
                            <tr class="hover:bg-[hsl(36_50%_98%)]/50">
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    ?>
                                    <span class="inline-flex px-2 py-1 text-xs font-medium <?php echo $badge_class; ?> rounded-full"><?php echo $label; ?></span>
                                </td>
                                <td class="px-4 py-3 text-[hsl(25_15%_42%)]"><?php echo date('d/m/Y H:i', strtotime($cmd['created_at'])); ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
                ...
                <div class="text-center py-12 text-[hsl(25_15%_42%)]">
                    <svg class="h-12 w-12 mx-auto mb-4 text-[hsl(30_25%_86%)]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
                    Aucune commande
                </div>
                <?php endif; ?>
            </div>
