...
<section class="flex min-h-[60vh] items-center justify-center">
    <div class="text-center">
        ...
        <a href="/saveur-php/" class="inline-flex items-center gap-2 rounded-2xl px-6 py-3 bg-gradient-warm text-[hsl(38_60%_97%)] font-medium shadow-warm hover:opacity-90 transition-opacity">
